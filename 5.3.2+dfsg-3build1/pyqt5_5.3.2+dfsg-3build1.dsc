...
Format: 3.0 (quilt)
Source: pyqt5
Binary: python3-pyqt5, python3-pyqt5-dbg, python3-dbus.mainloop.pyqt5, python3-dbus.mainloop.pyqt5-dbg, python3-pyqt5.enginio, python3-pyqt5.enginio-dbg, python3-pyqt5.qtopengl, python3-pyqt5.qtopengl-dbg, python3-pyqt5.qtsql, python3-pyqt5.qtsql-dbg, python3-pyqt5.qtwebkit, python3-pyqt5.qtwebkit-dbg, python3-pyqt5.qtwebsockets, python3-pyqt5.qtwebsockets-dbg, python3-pyqt5.qtxmlpatterns, python3-pyqt5.qtxmlpatterns-dbg, python3-pyqt5.qtsvg, python3-pyqt5.qtsvg-dbg, python3-pyqt5.qtmultimedia, python3-pyqt5.qtmultimedia-dbg, python3-pyqt5.qtquick, python3-pyqt5.qtquick-dbg, python3-pyqt5.qtserialport, python3-pyqt5.qtserialport-dbg, python3-pyqt5.qtsensors, python3-pyqt5.qtsensors-dbg, python3-pyqt5.qtx11extras, python3-pyqt5.qtx11extras-dbg, python3-pyqt5.qtpositioning, python3-pyqt5.qtpositioning-dbg, pyqt5-dev, pyqt5-doc, pyqt5-examples, pyqt5-dev-tools, python-pyqt5, python-pyqt5-dbg, python-dbus.mainloop.pyqt5, python-dbus.mainloop.pyqt5-dbg, python-pyqt5.enginio,
...
Checksums-Sha1:
 bf4d3b3dc0015358a4dedfb2d293b2dc3fdd0467 3122564 pyqt5_5.3.2+dfsg.orig.tar.gz
 daf78a1da75868a89fea78dd8aa9297043fc046a 14220 pyqt5_5.3.2+dfsg-3build1.debian.tar.xz
Checksums-Sha256:
 984d4332ceaf75512ca38890cbf6134d97971762cf1d68ea024a854933ebda51 3122564 pyqt5_5.3.2+dfsg.orig.tar.gz
 ae937ffc23b874be486a355d168e378049d485b5a14e76a5fa69e7231fba3426 14220 pyqt5_5.3.2+dfsg-3build1.debian.tar.xz
Files:
 ae4ef98efb91f453fcbafe55afa7ceaa 3122564 pyqt5_5.3.2+dfsg.orig.tar.gz
 a64eb91cc19dc754170baa5e8af8e85f 14220 pyqt5_5.3.2+dfsg-3build1.debian.tar.xz

-----BEGIN PGP SIGNATURE-----
Version: GnuPG v1


48NdUrIIN4nofF55ISZw
=VJsM
-----END PGP SIGNATURE-----
