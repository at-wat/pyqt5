...
Vcs-Git: git://anonscm.debian.org/python-modules/packages/pyqt5.git
Testsuite: autopkgtest
Build-Depends: debhelper (>= 9), dh-python, dpkg-dev (>= 1.16.1~), libdbus-1-dev (>= 1.0.2), libglib2.0-dev, libicu-dev, libpulse-dev, libqt5opengl5-dev (>= 5.4.0), libqt5sensors5-dev (>= 5.4.0), libqt5serialport5-dev (>= 5.4.0), libqt5svg5-dev (>= 5.4.0), libqt5webkit5-dev (>= 5.4.0), libqt5websockets5-dev (>= 5.4.0), libqt5x11extras5-dev (>= 5.4.0), libqt5xmlpatterns5-dev (>= 5.4.0), libsqlite3-dev, libudev-dev [linux-any], libxml2-dev, libxslt1-dev, python-all-dbg, python-all-dev (>= 2.6.6-3~), python-dbus, python-dbus-dbg, python-dbus-dev, python-sip-dbg, python-sip-dev (>= 4.16.8+dfsg-2~), python3-all-dbg, python3-all-dev (>= 3.3.2-5~), python3-dbus, python3-dbus-dbg, python3-sip-dbg, python3-sip-dev (>= 4.16.8+dfsg-2~), qtdeclarative5-dev (>= 5.4.0), qtlocation5-dev (>= 5.4.0), qtmultimedia5-dev (>= 5.4.0), qtpositioning5-dev (>= 5.4.0), qttools5-dev (>= 5.4.0)
...
Checksums-Sha1:
 79504404ae35e92435d6b5004194bc91389296eb 3063206 pyqt5_5.5.1+dfsg.orig.tar.gz
 4c404f97e9edd4e840689e30ccae5b4b2e42f143 15728 pyqt5_5.5.1+dfsg-3ubuntu5.debian.tar.xz
Checksums-Sha256:
 82714c047f5cfcca45e5f826050aad4e8156f8c8426ed37633afa39964e03e70 3063206 pyqt5_5.5.1+dfsg.orig.tar.gz
 a186c407daa8806a78882446f4b129c75508f3ae7e82204021249fd5d786efc5 15728 pyqt5_5.5.1+dfsg-3ubuntu5.debian.tar.xz
Files:
 ded62531dc1cea750157e00ef5e205f3 3063206 pyqt5_5.5.1+dfsg.orig.tar.gz
 11756737e6d074d2cb082b033f4bd33b 15728 pyqt5_5.5.1+dfsg-3ubuntu5.debian.tar.xz
Original-Maintainer: Debian Python Modules Team <python-modules-team@lists.alioth.debian.org>

-----BEGIN PGP SIGNATURE-----
Version: GnuPG v2


LLO77hV4c1JvXIdVYzhP
=gFIM
-----END PGP SIGNATURE-----
