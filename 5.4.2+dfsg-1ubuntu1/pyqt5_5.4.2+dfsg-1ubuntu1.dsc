...
Build-Depends: debhelper (>= 9), dpkg-dev (>= 1.16.1~), fdupes, libdbus-1-dev (>= 1.0.2), libenginio1-dev (>= 5.4.2), libglib2.0-dev, libgstreamer-plugins-base0.10-dev, libgstreamer0.10-dev, libicu-dev, libpulse-dev, libqt5opengl5-dev (>= 5.4.2), libqt5sensors5-dev (>= 5.4.2), libqt5serialport5-dev (>= 5.4.2), libqt5svg5-dev (>= 5.4.2), libqt5webkit5-dev (>= 5.4.2), libqt5websockets5-dev (>= 5.4.2), libqt5x11extras5-dev (>= 5.4.2), libqt5xmlpatterns5-dev (>= 5.4.2), libsqlite3-dev, libudev-dev [linux-any], libxml2-dev, libxslt1-dev, python-all-dbg, python-all-dev (>= 2.6.6-3~), python-dbus, python-dbus-dbg, python-dbus-dev, python-sip-dbg, python-sip-dev (>= 4.16.8+dfsg-2~), python3-all-dbg, python3-all-dev (>= 3.3.2-5~), python3-dbus, python3-dbus-dbg, python3-sip-dbg, python3-sip-dev (>= 4.16.8+dfsg-2~), python3-sphinx, qtdeclarative5-dev (>= 5.4.2), qtmultimedia5-dev (>= 5.4.2), qtpositioning5-dev (>= 5.4.2), qttools5-dev (>= 5.4.2)
Package-List:
 ...
 python-pyqt5.enginio deb python optional arch=any
 python-pyqt5.enginio-dbg deb debug extra arch=any
 ...
 python3-pyqt5.enginio deb python optional arch=any
 python3-pyqt5.enginio-dbg deb debug extra arch=any
...
Checksums-Sha1:
 ee09e5e8ab3b009cd6851c256e3d56e896fe9e16 3034100 pyqt5_5.4.2+dfsg.orig.tar.gz
 3388ea4b503b5fd48f1760f0cb975ae75e2f539c 15580 pyqt5_5.4.2+dfsg-1ubuntu1.debian.tar.xz
Checksums-Sha256:
 cf76528784ce8e92b8c0192b939b6c10897737dc9931f405d5d3ec9f6048b9ac 3034100 pyqt5_5.4.2+dfsg.orig.tar.gz
 64e72aa3bf6ad4de824904c3a0f3e2d949c4ad1bddbf5411c3f531e0c2a6d0d6 15580 pyqt5_5.4.2+dfsg-1ubuntu1.debian.tar.xz
Files:
 bb4da3ad4b5620c45fa2b373c0d9cabc 3034100 pyqt5_5.4.2+dfsg.orig.tar.gz
 e14c3c31655308862a25b96184cd5e32 15580 pyqt5_5.4.2+dfsg-1ubuntu1.debian.tar.xz
Original-Maintainer: Debian Python Modules Team <python-modules-team@lists.alioth.debian.org>

-----BEGIN PGP SIGNATURE-----
Version: GnuPG v1


GUSTO53Iu5XkY77WoICZ
=lGek
-----END PGP SIGNATURE-----
